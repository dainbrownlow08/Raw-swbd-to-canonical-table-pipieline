...
# The package lives under "Feature Extractors/" (space → not importable as a
# package path), so the tests put it on sys.path themselves.
sys.path.insert(0, str(REPO / "Feature Extractors"))
